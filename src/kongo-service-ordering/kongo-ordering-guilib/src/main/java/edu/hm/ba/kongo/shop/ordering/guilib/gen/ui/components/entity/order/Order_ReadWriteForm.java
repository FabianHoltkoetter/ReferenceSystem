...
/**
 * Provides a full-featured Form for a Order_. It allows to view the current selected order and edit it.
 */
public class Order_ReadWriteForm extends BaseComponent {
	...
	protected final ActionButton cancelButton = new ActionButton(Order_.class, SimpleAction.cancel);
	
	/** The button for the edit action. */
	protected final ActionButton editButton = new ActionButton(Order_.class, SimpleAction.update);

    /** The Form displaying the current selected Order_. */
    ...
    /**
     * Create a new Order_ReadWriteForm with the internationalization of the Controller.
     * It will navigate to the navigateBack value on the back button click.
     */
    public Order_ReadWriteForm() {
    ...
    protected void init() {
    	...
    	if(principal.getAuthorities().contains("ordering_READ_Order")){
    ...
    /**
     * Get the Order_SelectedForm used by this RWForm.
     * @return The Order_SelectedForm.
     */
