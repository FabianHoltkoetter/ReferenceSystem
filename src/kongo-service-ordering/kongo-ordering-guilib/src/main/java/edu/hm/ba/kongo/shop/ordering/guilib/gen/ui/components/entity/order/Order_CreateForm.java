...
/**
 * Provides a simple Form for creating a new Order_.
 */
public class Order_CreateForm extends Order_Form {
	...
	/**
	 * Create a new Order_CreateForm that navigates to the navigateTo View on save.
	 *
	 * @param navigateTo The String of the view to navigate to on save.
	 */
    public Order_CreateForm(final String navigateTo) {
	...
	protected void configureSaveButton() {
        Order_SingleActions orderSingleActions = new Order_SingleActions(this::getOrder);
        getSaveButton().addActionPerformer(orderSingleActions::create);
