 ...
 */
@Service
@PreAuthorize("hasAuthority('ordering_BUSINESSACTION_CancelOrder')")
public class CancelOrder_BusinessActionServiceImpl implements CancelOrder_BusinessActionService {
	 ...
	 */
	@Override
	public void cancelOrder(Map<String, Object> header, String orderID){
		...
		throw new UnsupportedOperationException("The BusinessAction cancelorder is not yet implemented!");
	}
