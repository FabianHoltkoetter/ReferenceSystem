package edu.hm.ba.kongo.infrastructure.auth;

import edu.hm.ba.kongo.infrastructure.auth.configurator.JDBCAuthenticationConfigurator;
import edu.hm.ba.kongo.infrastructure.auth.configurator.LDAPAuthenticationConfigurator;
...
@EnableEurekaClient
@Configuration
@EntityScan(basePackages = {"edu.hm.ba.kongo.infrastructure.auth"})
@EnableJpaRepositories(basePackages = {"edu.hm.ba.kongo.infrastructure.auth"})
@EnableAutoConfiguration
@ComponentScan(basePackages = {"de.muenchen.service", "edu.hm.ba.kongo.infrastructure.auth"})
