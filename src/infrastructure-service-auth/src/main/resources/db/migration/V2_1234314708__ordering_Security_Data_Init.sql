...
-- Permissions for entity: orderingItem
insert into _permissions (oid,perm_permission) values ('00000000-4992-25d4-0000-000005f5e100','ordering_READ_OrderingItem');
insert into _permissions (oid,perm_permission) values ('00000000-4992-25d4-0000-00000bebc200','ordering_WRITE_OrderingItem');
insert into _permissions (oid,perm_permission) values ('00000000-4992-25d4-0000-000011e1a300','ordering_DELETE_OrderingItem');
