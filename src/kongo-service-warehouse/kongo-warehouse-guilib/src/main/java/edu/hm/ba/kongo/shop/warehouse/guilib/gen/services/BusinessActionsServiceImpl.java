...
import edu.hm.ba.kongo.shop.warehouse.client.businessactions.BusinessActionsRestClientImpl;
 ...
 */
@SpringComponent("warehouse_BusinessActionsService")
@UIScope
public class BusinessActionsServiceImpl implements BusinessActionsService {
	 ...
	 */
	@Autowired
	public BusinessActionsServiceImpl(SecurityService securityService, @Value("${WAREHOUSE.microservice.basePath}") String basePath) {
