package edu.hm.ba.kongo.shop.shoppingcart.service.gen.controller.businessactions;
...
public class BusinessActionController implements ResourceProcessor<RepositoryLinksResource> {
	...
	@Autowired
	AddToCart_BusinessActionService addToCartactionService;
	@Autowired
    ...
    public List<Link> getMethodActions() {
		...
		methodLinks.add(new Link(base + "/addToCart", "addToCart"));
	...
	public ResponseEntity<?> addToCart(PersistentEntityResourceAssembler assembler, @RequestHeader Map<String, Object> headers, @RequestBody AddToCart_BusinessActionParameters body)
	{	
		addToCartactionService.addToCart(headers, body.getProductID(), body.getQuantity());
		return new ResponseEntity<>(HttpStatus.OK);
	}
